    ...
    <body>
        ...
        <main id="gestionReservas">
            ...
            <?php
                ...
                echo '<hr/>
                <div class="tarjeta" id="'.$datos[$i]["idReserva"].'">
                    <div class="img"></div>
                    <div>
                        <ul>
                            <li><p>NOMBRE Y APELLIDOS</p>
                                <ul>
                                    <li><p>'.$datos[$i]["nombre"].', '.$datos[$i]["apellidos"].'</p></li>
                                </ul>
                            </li>
                            <li><p>CURSO</p>
                                <ul>
                                    <li><p>'.$datos[$i]["codCurso"].'</p></li>
                                </ul>
                            </li>
                            <li><p>LIBRO</p>
                                <ul>
                                    <li><p>'.$datos[$i]["titulo"].'</p></li>
                                </ul>
                            </li>
                            <li><p>FECHA RESERVA</p>
                                <ul>
                                    <li><p>'.$datos[$i]["fechaReserva"].'</p></li>
                                </ul>
                            </li>
                            <li><p>FECHA ENTREGA</p>
                                <ul>
                                    <li><p>'.$datos[$i]["fechaEntrega"].'</p></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    <form action="">
                        <p id="numero">'.$datos[$i]["idReserva"].'<p>
                        <div>
                ...
                <p id="resultado'.$datos[$i]["idReserva"].'"></p>';}
            ?>
        </main>
        <footer>
